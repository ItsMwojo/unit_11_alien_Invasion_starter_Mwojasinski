...
from Functions.Misc_Functions.settings import Settings
from Functions.Misc_Functions.game_stats import GameStats
from Functions.Misc_Functions.scoreboard import Scoreboard
from Functions.Main_Functions.button import Button
from Functions.Main_Functions.ship import Ship
from Functions.Main_Functions.bullet import Bullet
from Functions.Main_Functions.alien import Alien
...
class AlienInvasion:
    ...
    def _update_screen(self):
        """Update Game_Images on the screen, and flip to the new screen."""
